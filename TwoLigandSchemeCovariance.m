\[CapitalSigma]data = 
    {{(kp*((c1*kon*(1 + (c1*kon)/koff + (c2*kon)/koff2)^2)/
      ...
      -((((-2*c1*c2^2*koff2*(1 + koff2/kf2)*kon^3)/(kf2*koff) - 
          (c2*koff*koff2*kon*((c1*kf2*(1 + koff2/kf2)*kon*(-1 + 
                (c1*kon)/koff - (c2*kon)/koff2 + (koff2*(-1 + (c1*kon)/koff + 
                   (5*c2*kon)/koff2))/kf2))/koff + kf*(1 + (c1*kon)/koff + 
               (2*c1^2*kon^2)/koff^2 + (c2^2*kon^2)/koff2^2 - (c1*c2*kon^2)/
                (koff*koff2) + (c1*koff2^2*kon*(-1 + (c1*kon)/koff - 
                  (c2*kon)/koff2))/(kf2^2*koff) + (koff2*(1 - (2*c2*kon)/
                   koff2 + (3*c1^2*kon^2)/koff^2 - (c2^2*kon^2)/koff2^2 - 
                  (4*c1*c2*kon^2)/(koff*koff2)))/kf2)))/(kf*kf2) + 
          (c2*koff^4*kon*((-2*c1^2*kf*kon^2)/koff^2 + 
             (c1*koff2*kon*(kf2*(1 + (c1*kon)/koff - (c2*kon)/koff2) - 
                kf*(-1 + (5*c1*kon)/koff + (c2*kon)/koff2)))/(kf2*koff) + 
             (koff2^2*(-((c1*kf*kon*(-3 + (3*c1*kon)/koff + (c2*kon)/koff2))/
                  koff) + kf2*(-1 + (c1*kon)/koff + (2*c1^2*kon^2)/koff^2 - 
                  (c2^2*kon^2)/koff2^2 - (c1*c2*kon^2)/(koff*koff2))))/
              kf2^2 + (koff2^3*((2*c1*kf*kon)/koff + kf2*(-1 + (2*c2*kon)/
                   koff2 + (c1^2*kon^2)/koff^2 + (c2^2*kon^2)/koff2^2 + 
                  (2*c1*c2*kon^2)/(koff*koff2))))/kf2^3))/(kf^3*koff2) - 
          (koff^2*koff2*(-((c1*c2*kf^2*(1 + koff2/kf2)*kon^2*
                (1 + (c1*kon)/koff - (c2*kon)/koff2 + (2*koff2*(1 + 
                    (c1*kon)/koff))/kf2))/(koff*koff2)) + 
             (c1*c2*kf2*(1 + koff2/kf2)*kon^2*((c1*kon)/koff - 
                3*(1 + (c2*kon)/koff2) + (koff2*(-3 + (c1*kon)/koff + 
                   (3*c2*kon)/koff2))/kf2))/koff + kf*kf2*
              ((c1^3*(1 + koff2/kf2)^3*kon^3)/koff^3 + (c1^2*c2*
                 (-1 + koff2/kf2 + (3*koff2^2)/kf2^2 + koff2^3/kf2^3)*kon^3)/
                (koff^2*koff2) + (3*c2*kon*(1 + (c2^2*kon^2)/koff2^2 - 
                  (koff2*(-1 + (2*c2*kon)/koff2 + (c2^2*kon^2)/koff2^2))/
                   kf2))/kf2 + (c1*kon*(1 + (c2*kon)/koff2 + (2*c2^2*kon^2)/
                   koff2^2 + (koff2^2*(3 + (4*c2*kon)/koff2 - (9*c2^2*kon^2)/
                      koff2^2))/kf2^2 + (koff2*(3 + (6*c2*kon)/koff2 + 
                     (c2^2*kon^2)/koff2^2))/kf2 - (koff2^3*(-1 + (c2*kon)/
                      koff2 + (2*c2^2*kon^2)/koff2^2))/kf2^3))/koff)))/
           (kf^2*kf2) + (koff^3*((-2*c1^2*c2*kf^2*kon^3)/(koff^2*koff2) + 
             (c1*kf*koff2*kon*((-2*c2*kf*kon*(-1 + (2*c1*kon)/koff + 
                   (c2*kon)/koff2))/koff2 + kf2*(-1 + (2*c1*kon)/koff + 
                  (c1^2*kon^2)/koff^2 - (3*c2^2*kon^2)/koff2^2 + 
                  (4*c1*c2*kon^2)/(koff*koff2))))/(kf2*koff) + 
             (c1*koff2^4*kon*((2*c2*kf2*kon)/koff2 + kf*(-1 + (c1^2*kon^2)/
                   koff^2 + (c2^2*kon^2)/koff2^2 + (2*c1*kon*(1 + (c2*kon)/
                      koff2))/koff)))/(kf2^3*koff) + 
             (koff2^3*((2*c1*c2*kf^2*kon^2*(2 + (c1*kon)/koff))/
                 (koff*koff2) + (2*c1*c2*kf2^2*kon^2*(2 + (c2*kon)/koff2))/
                 (koff*koff2) + kf*kf2*((3*c1^3*kon^3)/koff^3 + 
                  (c1^2*kon^2*(6 + (7*c2*kon)/koff2))/koff^2 + 
                  (3*c2*kon*(-1 + (2*c2*kon)/koff2 + (c2^2*kon^2)/koff2^2))/
                   koff2 + (c1*kon*(-3 - (4*c2*kon)/koff2 + (7*c2^2*kon^2)/
                      koff2^2))/koff)))/kf2^3 + 
             (koff2^2*((-2*c1*c2*kf^2*kon^2*(-3 + (c2*kon)/koff2))/
                 (koff*koff2) + (2*c1*c2*kf2^2*kon^2*(1 + (c2*kon)/koff2))/
                 (koff*koff2) + kf*kf2*((3*c1^3*kon^3)/koff^3 + 
                  (c1^2*kon^2*(6 + (9*c2*kon)/koff2))/koff^2 - 
                  (c1*kon*(3 + (4*c2*kon)/koff2 + (3*c2^2*kon^2)/koff2^2))/
                   koff - 3*((c2*kon)/koff2 + (c2^3*kon^3)/koff2^3))))/
              kf2^2))/kf^3)*kp*t)/(koff*(1 + koff/kf)^3*koff2*
         (1 + koff2/kf2)^3*(1 + (c1*kon)/koff + (c2*kon)/koff2)^3))}, 
     {-(kp*t*((2*(1 + koff/kf)*(1 + koff2/kf2)*(c1*kon + c2*kon)*
            (-((c1*c2*koff2*kon^2)/(kf2*koff)) + (c2*koff^2*kon*(koff2/kf2 - 
                (c1*kon)/koff))/(kf*koff2) + (koff*koff2*(
     ...
     {-((((2*c1*c2*koff2*(1 + koff2/kf2)*kon^2*(1 + koff2/kf2 + 
      ...
      (kp*((c1*kon*(1 + (c1*kon)/koff + (c2*kon)/koff2)^2)/
         ...
         (2*((c2*koff*(1 + koff/kf)*kon*(1 + koff/kf + (c1*kon)/kf)^2)/
           ...
           (1 + koff2/kf2)^3))*t)/(1 + (c1*kon)/koff + (c2*kon)/koff2)^3, 
      (((-2*c1*c2*koff2*(1 + koff2/kf2)*kon^2*(1 + koff2/kf2 + (c2*kon)/kf2))/
          koff - (c2*koff^4*kon*((2*c1*kf*kon*(1 + (c1*kon)/koff))/koff - 
            (koff2^3*(1 + (c1*kon)/koff + (c2*kon)/koff2)^2)/kf2^2 + 
            (koff2*(-(kf2*(1 + (c1*kon)/koff)*(1 + (c1*kon)/koff - 
                  (c2*kon)/koff2)) + (c1*kf*kon*(5 + (5*c1*kon)/koff + 
                  (c2*kon)/koff2))/koff))/kf2 + 
            (koff2^2*((c1*kf*kon*(3 + (3*c1*kon)/koff + (c2*kon)/koff2))/
                koff + kf2*(-2 + (c2*kon)/koff2 - (2*c1^2*kon^2)/koff^2 + 
                 (c2^2*kon^2)/koff2^2 + (c1*kon*(-4 + (c2*kon)/koff2))/
                  koff)))/kf2^2))/(kf^3*koff2) + 
         (koff*koff2*(-((c1*c2*(1 + koff2/kf2)*kon^2*(5 + (c1*kon)/koff - 
                (c2*kon)/koff2 + (koff2*(5 + (c1*kon)/koff + (5*c2*kon)/
                    koff2))/kf2))/koff) + kf*(-((c1^2*(1 + koff2/kf2)*kon^2*
                 (1 + (2*koff2*(1 + (c2*kon)/koff2))/kf2 + 
                  (koff2^2*(1 + (c2*kon)/koff2))/kf2^2))/koff^2) + 
              (c2*kon*(1 - (c2*kon)/koff2 + (koff2^2*(1 + (c2*kon)/koff2)^2)/
                  kf2^2 - (koff2*(-2 + (c2*kon)/koff2 + (c2^2*kon^2)/
                     koff2^2))/kf2))/koff2 + (c1*kon*(1 + (2*c2*kon)/koff2 + 
                 (koff2^3*(1 + (c2*kon)/koff2)^2)/kf2^3 + 
                 (koff2*(3 + (5*c2*kon)/koff2 + (c2^2*kon^2)/koff2^2))/kf2 + 
                 (koff2^2*(3 + (5*c2*kon)/koff2 + (4*c2^2*kon^2)/koff2^2))/
                  kf2^2))/koff)))/kf + 
         (koff^3*((-2*c1*c2*kf^2*kon^2*(2 + (c1*kon)/koff))/(koff*koff2) + 
            (c1*kf*koff2^4*kon*(1 + (c1*kon)/koff + (c2*kon)/koff2)^2)/
             (kf2^3*koff) + (kf*koff2*((-2*c1*c2*kf*kon^2*(5 + (2*c1*kon)/
                   koff + (c2*kon)/koff2))/(koff*koff2) + kf2*
                ((c1^3*kon^3)/koff^3 - (3*c2*kon*(-1 + (c2*kon)/koff2))/
                  koff2 + (c1^2*kon^2*(2 + (4*c2*kon)/koff2))/koff^2 + 
                 (c1*kon*(1 + (5*c2*kon)/koff2 - (3*c2^2*kon^2)/koff2^2))/
                  koff)))/kf2 + (koff2^2*((2*c1*c2^2*kf2^2*kon^3)/
                (koff*koff2^2) - (2*c1*c2*kf^2*kon^2*(3 + (c2*kon)/koff2))/
                (koff*koff2) + kf*kf2*((3*c1^3*kon^3)/koff^3 + 
                 (c1^2*kon^2*(6 + (9*c2*kon)/koff2))/koff^2 + 
                 (c1*kon*(3 + (11*c2*kon)/koff2 - (3*c2^2*kon^2)/koff2^2))/
                  koff - (3*c2*kon*(-2 + (c2*kon)/koff2 + (c2^2*kon^2)/
                     koff2^2))/koff2)))/kf2^2 + 
            (koff2^3*((2*c1*c2^2*kf2^2*kon^3)/(koff*koff2^2) + (2*c1^2*c2*
                 kf^2*kon^3)/(koff^2*koff2) + kf*kf2*((3*c1^3*kon^3)/koff^3 + 
                 (3*c2*kon*(1 + (c2*kon)/koff2)^2)/koff2 + (c1^2*kon^2*
                   (6 + (7*c2*kon)/koff2))/koff^2 + (c1*kon*(3 + (8*c2*kon)/
                     koff2 + (7*c2^2*kon^2)/koff2^2))/koff)))/kf2^3))/kf^3 - 
         (koff^2*((2*c1*c2*kf^2*kon^2)/(koff*koff2) + 
            (c1*koff2^4*kon*((c2*kf2*kon*(3 + (c1*kon)/koff + (3*c2*kon)/
                   koff2))/koff2 + kf*((c1^2*kon^2)/koff^2 + 
                 (c1*kon*(1 + (c2*kon)/koff2))/koff - 2*(1 + (c2*kon)/koff2)^
                   2)))/(kf2^3*koff) + (koff2^2*((c1*c2*kf2^2*kon^2*
                 (3 + (c1*kon)/koff - (3*c2*kon)/koff2))/(koff*koff2) + 
               (c1*c2*kf^2*kon^2*(3 - (3*c1*kon)/koff + (c2*kon)/koff2))/
                (koff*koff2) + kf*kf2*((3*c1^3*kon^3)/koff^3 + 
                 (c1^2*kon^2*(3 + (c2*kon)/koff2))/koff^2 + 
                 (c1*kon*(-6 - (12*c2*kon)/koff2 + (c2^2*kon^2)/koff2^2))/
                  koff + (3*c2*kon*(-2 + (c2*kon)/koff2 + (c2^2*kon^2)/
                     koff2^2))/koff2)))/kf2^2 + 
            (kf*koff2*((c1*c2*kf*kon^2*(5 - (c1*kon)/koff + (c2*kon)/koff2))/
                (koff*koff2) + kf2*((c1^3*kon^3)/koff^3 + (3*c2*kon*
                   (-1 + (c2*kon)/koff2))/koff2 - (c1^2*kon^2*(-1 + 
                    (c2*kon)/koff2))/koff^2 + (c1*kon*(-2 - (5*c2*kon)/
                     koff2 + (2*c2^2*kon^2)/koff2^2))/koff)))/kf2 - 
            (koff2^3*((2*c1^2*c2*kf^2*kon^3)/(koff^2*koff2) - (2*c1*c2*kf2^2*
                 kon^2*(3 + (c1*kon)/koff))/(koff*koff2) + kf*kf2*
                ((-3*c1^3*kon^3)/koff^3 - (3*c1^2*kon^2*(1 + (c2*kon)/koff2))/
                  koff^2 + (3*c2*kon*(1 + (c2*kon)/koff2)^2)/koff2 + 
                 (c1*kon*(6 + (11*c2*kon)/koff2 + (9*c2^2*kon^2)/koff2^2))/
                  koff)))/kf2^3))/kf^2)*kp*t)/(koff*(1 + koff/kf)^3*koff2*
        (1 + koff2/kf2)^3*(1 + (c1*kon)/koff + (c2*kon)/koff2)^3)}, 
     {-((((-2*c1*c2^2*koff2*(1 + koff2/kf2)*kon^3)/(kf2*koff) - 
          (c2*koff*koff2*kon*((c1*kf2*(1 + koff2/kf2)*kon*(-1 + 
                (c1*kon)/koff - (c2*kon)/koff2 + (koff2*(-1 + (c1*kon)/koff + 
