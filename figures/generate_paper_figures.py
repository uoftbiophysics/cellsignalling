...
def figure_1_and_2_heatmaps(arrRelErrorEst1X, arrRelErrorEst2C, arrRelErrorEst2KOFF, array_x, array_y, fname1, fname2, fname3, labels, log_select):
    ...
    fig0 = plt.figure(figsize=(2.8, 2.2)); fig0 = plt.gcf()
    ax0 = plt.gca()
    # axes setup
    ...
    fig1 = plt.figure(figsize=(2.8, 2.2)); fig1 = plt.gcf()
    ax1 = plt.gca()
    # axes setup
    ...
    fig2 = plt.figure(figsize=(2.8, 2.2)); fig2 = plt.gcf()
    ax2 = plt.gca()
    # axes setup
...
def plot_S3():
    dictionary_SI = {'subdir2': 'SI_ratios', 'log': True,
                        'plots': {
